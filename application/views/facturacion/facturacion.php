                    ...
                    <div class="portlet light bordered">
                        ...
                        <form role="form" class="form-horizontal form-label-left">
                            <div class="form-group">
                                <label class="col-lg-2 control-label">Seleccionar</label>
                                <div class="col-md-8 col-sm-8 col-xs-12">
                                    <select id="filtro1" class="form-control">
                                        <option value="ospia" selected>OSPIA</option>
                                        <option value="colegio">Colegio de Bioquimicos</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                           ...
                           <div class="form-group">
                            ...
                            <div class="form-group">
                                <label class="col-lg-2 control-label" for="criterio">Factor</label>
                                <div class="col-md-8 col-sm-8 col-xs-12">
                                    <input type="number" min="1" value="1" class="form-control" id="criterio" placeholder="Criterio de Busqueda" required>
                                </div>
                            </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet light ">
                        <div class="portlet-title">
                            ...
                            <div class="actions">
                                <div class="btn-group">
                                    <a class="btn btn-sm green "> Imprimir
                        ...
                        <div class="portlet-body">
                            <div id="sample_1_wrapper" class="dataTables_wrapper">
                                <div class="row">
                                    <div class="col-md-12">
                                       <?php $this->load->view('facturacion/tabla_ospia');?>
                                    </div>
                                </div>
                            </div>
                        </div>
